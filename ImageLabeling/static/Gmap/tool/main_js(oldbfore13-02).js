...
//    "use strict"
    ...
    function drawIntro(context){
        ...
        img.onload = function() {
            ...
            context.drawImage(img, zoomX(0), zoomY(0), zoom(640), zoom(640)) 
            currentImage=img;               
        }
        img.src = image_path;
    ...
    const trackPointer = (event) => {
        ...
        if (event.type === "mousedown") {
            ...
            if (mouse.buttonL === true && currentClass !== null) {
    ...
    const setCurrentImage = (image,image_path1=0) => {
