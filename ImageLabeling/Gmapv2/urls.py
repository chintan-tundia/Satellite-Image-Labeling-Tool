...
urlpatterns = [
    ...
    url(r'^ajax/save_image_checkdams$', views.save_image_checkdams, name='save_image_checkdams'),	
	...
	url(r'^ajax/get_image_list_cd$', views.getImageListCD, name='getImageListCD'),
    ...
    url(r'^downloaddatasetcheckdams$', views.downloadDatasetCheckdams, name='downloadDatasetCheckdams'),
